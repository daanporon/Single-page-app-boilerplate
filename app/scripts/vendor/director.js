...
/*
 * CHANGES:
 * line 366: fix regexp so that we can add regexp stuff after a parameter for example: /:item(\\?[\\.-_a-zA-Z0-9=&]+)?
 */
...
function regifyString(str, params) {
  ...
  var captures = str.match(/:([a-zA-Z0-9_-]+)/ig), length; // fix this so that we can use regexp after a parameter ...
  if (captures) {
